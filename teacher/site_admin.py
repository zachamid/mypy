 			...
 			function getUnassignedList(){
 				...
 				run_admin_query('ClassList',data, function(result){
    					...
    					for (student in result){
    						...
    						row.insertCell(3).innerHTML = "<select class='form-control' id='classSelect"+result[student]['StudentID']+"'></select>&nbsp<button class='form-control' onclick='AssignStudentToClass("+result[student]['StudentID']+")'>Assign</button>";
...
print """\n
		<div class="container col-sm-12 col-md-12">
			<div class="panel panel-default translucent" style='width:100%;display: inline-block'>
				<div class="panel col-sm-12 col-md-6 translucent" style=''>
					<h4>Add Class</h4></br>
					<table>
						<tr>
							<td>
				...
				<div class="container col-sm-12 col-md-6 translucent" style=''>
